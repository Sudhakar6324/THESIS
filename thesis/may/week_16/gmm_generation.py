...
parser = argparse.ArgumentParser(description="Process 3D VTI files.")
parser.add_argument("--input_file", type=str, required=True, help="Path to the input VTI file")
parser.add_argument("--output_file", type=str, required=True, help="Path to the output VTI file")

args = parser.parse_args()

input_file = args.input_file
output_file = args.output_file # Output filename
...
print(f"Loaded grid: {dims}, total points: {num_points}",flush=True)
