...
def compute_rmse_all(total_vars,var_name,actual,predicted):
    ...
    for i in range(total_vars):
        rmse= compute_rmse(actual[:,j], predicted[:,j])
...
args = Namespace(
    ...
    decay_interval=15,
    datapath='new_gmm_isabel_week_6.vti',  # Required: Set the path to your data
    outpath='./models/',
    exp_path='../logs/',
...
# ========== Config ==========
neuron_settings = [300,350,400,450, 500]
all_total_losses = {}
all_psnrs = {}
...
def train_and_evaluate(n_neurons):
    ...
    n_predictions = denormalizeValue(total_vars, n_predictions, real_data)
    ...
    psnr_list, avg_psnr = findMultiVariatePSNR(var_name, total_vars, n_val, n_predictions)
