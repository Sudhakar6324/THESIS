...
reader.SetFileName("GT_teardrop_128x128x128.vti")
reader.Update()
...
for name in array_names:
    ...
    mean, std = compute_mean_std(arr, np.array(x), np.array(y), np.array(z), mode=24)
...
writer.SetFileName("new_teardrop_gaussian.vti")
